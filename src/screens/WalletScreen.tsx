  ...
  if (loading) {
    return (
      <View style={styles.loadingContainer}>
        <Text style={styles.loadingText}>{t('wallet.loadingWallet')}</Text>
      </View>
    );
  }
...
const styles = StyleSheet.create({
  ...
  balanceCard: { backgroundColor: '#0D61FF', borderRadius: 20, padding: 32, alignItems: 'center', marginBottom: 24 },
